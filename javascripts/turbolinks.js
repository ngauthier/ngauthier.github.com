...
(function() {
  ...
  if (((_ref1 = window.history) != null ? _ref1.pushState : void 0) && window.history.replaceState) {
    document.addEventListener('page:change', function(event) {
      if (window._gaq !== void 0) {
